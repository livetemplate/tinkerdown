...
import { BlockConfig, BlockMetadata, ExecMeta, CacheMeta } from "../types";
...
export abstract class BaseBlock {
   ...
   */
  abstract handleMessage(action: string, data: any, execMeta?: ExecMeta, cacheMeta?: CacheMeta): void;
